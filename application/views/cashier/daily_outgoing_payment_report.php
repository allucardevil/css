...
<input type="button" onclick="printDiv('printableArea')" value="Print Invoice" />	    
    	<div class="row-fluid">
			...
			<div class="block">
            	<a href="#outgoing_report" class="block-heading" data-toggle="collapse"><i class="icon-briefcase"></i>Daily Payment Outgoing Report &nbsp; &nbsp;<i class="icon-calendar"></i><?php echo mdate("%d-%m-%Y", strtotime($start_date)); ?>  - <?php echo mdate("%d-%m-%Y", strtotime($end_date)); ?><span class="label label-important"><?php echo $total; ?></span> </a>
        		<div id="outgoing_report" class="block-body collapse in">
