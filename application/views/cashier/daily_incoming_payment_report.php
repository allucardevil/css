<div class="container-fluid">
	<div class="row-fluid">
		...
		<?php echo form_open('cashier/payment/do_search_payment',"class='form-search'"); ?>
...
<input type="button" onclick="printDiv('printableArea')" value="Print Invoice" />
    	...
    	<div class="row-fluid">
        	...
        	<div class="block">
            	<a href="#incoming_report" class="block-heading" data-toggle="collapse"><i class="icon-briefcase"></i>Daily Payment Incoming Report &nbsp; &nbsp;<i class="icon-calendar"></i><?php echo mdate("%d-%m-%Y", strtotime($start_date)); ?>  - <?php echo mdate("%d-%m-%Y", strtotime($end_date)); ?><span class="label label-important"><?php echo $total; ?></span> </a>
        		<div id="incoming_report" class="block-body collapse in">
