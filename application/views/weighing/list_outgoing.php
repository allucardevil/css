...
<input type="button" onclick="printDiv('printableArea')" value="Print Invoice" />
    	...
    	<div class="row-fluid">
        	<div class="block">
            	<a href="#page-stats" class="block-heading" data-toggle="collapse"><i class="icon-briefcase"></i>BTB Report &nbsp; &nbsp;<i class="icon-calendar"></i><?php echo mdate("%d-%m-%Y", strtotime($start_date)); ?>  - <?php echo mdate("%d-%m-%Y", strtotime($end_date)); ?><span class="label label-important"><?php echo $total; ?></span> </a>
